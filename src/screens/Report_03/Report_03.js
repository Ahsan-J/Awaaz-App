...
class Report_03 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      victims : 0,
      ...
      <Container>
        ...
        <Content contentContainerStyle={styles.contentContainer} style={styles.container}>
          ...
          <View style={styles.headingTextWrapper}>
            <Text style={styles.headingText}>Victim Details</Text>
          </View>
          <Form style={styles.form}>
            <View style={styles.victimsControls}>
              <View style={styles.radioQuestionWrapper}>
                <View style={{flex:0.6}}>
                  <Text style={styles.radioText}>Are you the victim ?</Text>
                </View>
              ...
              <View style={styles.radioQuestionWrapper}>
                <Text style={[styles.radioText]}>Number of Victim(s)</Text>
...
export default connect(f.mapStateToProps.bind(this), f.mapDispatchToProps.bind(this))(Report_03)